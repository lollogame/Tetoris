...
class GameController {
  ...
  async startRound(seed, roundNumber, roundId) {
    // NEW: set the active round token before anything else
  ...
  handleNetworkMessage(msg) {
    switch (msg.type) {
      ...
      case 'gameState': {
        ...
        // NEW: ignore stale packets from older rounds
